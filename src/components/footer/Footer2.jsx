...
import svpcetlogo from "../../assets/images/svpcetLogo.png";
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="footer__main">
              <div className="info-left ml-[5%]  flex flex-col justify-center items-center  gap-16">
                <div className="flex gap-9 justify-center items-center">
                <Link to="/" className="logo">
                  <img src={logo} alt="Cyfonii" width={140} />
                </Link>
                ...
                <h1 className="opacity-[0.6] -mt-4">
                  St. Vincent Pallotti College of Engineering & Technology,
                  Gavsi Manapur, Wardha Road, Nagpur, Maharashtra India, Pin :
                  441108
                </h1>
              </div>
              ...
              <div className="right  mr-[5%]">
                <div className="flex flex-col items-end gap-6">
                  {/* <h1 className="text-[25px] font-bold">Contact Info</h1>
                    <div className="flex flex-col text-[18px] gap-2 opacity-[0.6]">
                    <span className="">name(post): +91 number</span>
                    <span className="">name(post): +91 number</span>
                    <span className="">name(post): +91 number</span>
                    <span className="">name(post): +91 number</span>
                    <span className="">name(post): +91 number</span>
                  ...
                  <div className=" flex justify-end">
                    <img src={svpcetlogo} alt="svpcet logo" className="xl:w-[70%]" />
                  </div>
                  <div>
                ...
                <div className="bottom">
                  <p>Copyright © 2023, teamOverFlow. Designed by Bhavesh</p>
                </div> */}
              </div>
            </div>
          </div>
