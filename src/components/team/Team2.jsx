                        ...
                        <div className="row justify-content-center">
                            <div className="col-12">
                                <div className="block-text center">
                                    ...
                                    <h3 className="heading wow xl:text-[40px] sm:text-[40px] lg:text-[40px] text-[30px] font-bold" data-splitting>Our Amazing Team
                                        <br />
                                        Members</h3>
                                </div>
...

                            {
                                data.slice(4,11).map(idx => (
                                    <div key={idx.id} className="col-xl-3 col-lg-3 col-md-4 col-sm-5 flex justify-center">
